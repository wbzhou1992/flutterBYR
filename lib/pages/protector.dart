...
// 条目总数
  ...
  TextStyle _getTextStyle(double size,{Color color}){
    return TextStyle(fontSize: size,color:color,decoration: TextDecoration.none,height:1.4);
  }
  Widget _getList() {
    return Container(
      child: Row(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Image.asset('assets/images/vip.png', width: 23.0, height: 14.0, fit: BoxFit.fill),
                  ]
                ),
                Text(
                  '2020年3月30日到期',
