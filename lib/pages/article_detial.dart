...
class ArticleDetail extends StatefulWidget {
  ...
  ArticleDetail({Key key, this.boardName, this.id, this.colorIndex})
      : super(key: key);
...
class ArticleDetailState extends State<ArticleDetail>
  ...
  Widget build(BuildContext context) {
    // 获取路由参数
    return Scaffold(appBar: _getAppBar(widget.colorIndex), body: _getBody());
  }
      ...
      Container(
          ...
          child: Row(children: [
            Padding(
              ...
              child: Icon(IconData(0xe638, fontFamily: 'MyIcons'),
            ...
            Expanded(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: Icon(IconData(0xe639, fontFamily: 'MyIcons'),
    ...
    return Padding(
        ...
        child: Row(children: <Widget>[
          Padding(
            ...
            child: divider == 1
                ? Icon(IconData(0xe60c, fontFamily: 'MyIcons'),
                    size: 20, color: Colors.red)
                : Icon(IconData(0xe51a, fontFamily: 'MyIcons'),
                    size: 20, color: Colors.orange),
          ),
          divider == 1
              ? Text('精彩回复', style: TextStyle(color: Colors.blue, fontSize: 12))
              : Text('全部回复',
          ...
          children: [
            ...
            Container(
              child: Row(
                  ...
                  children: <Widget>[
                    Text(isDown ? user['thumbUp'] : user['thumbDown'],
                  ...
                  MarkdownBody(
                      onTapLink: (url) {
                        Navigator.push(context,
                          ...
                          return Container(
                              width: 100,
                              child: MyWebview(url: url, title: '浏览网页'));
                        }));
                      },
                      data: markdown,
  ...
  Widget decodeArticle(List list, int index, var context) {
    ...
    var conList = content
        .replaceAll(RegExp(r'<br/>|<br>|<br\s/>|-|<img(.*)?>|<href(.*)?>'), '')
        .split(exp);
    ...
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Padding(
              ...
              child: Text(conList[0], style: TextStyle(fontSize: 16))),
          Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      Icon(IconData(0xe70d, fontFamily: 'MyIcons'),
